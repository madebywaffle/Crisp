...
public final class CrispVersionFetcher implements VersionFetcher {
    ...
    private static final String REPOSITORY = "madebywaffle/Crisp";
    private static final String DOWNLOAD_PAGE = "https://github.com/madebywaffle/Crisp/releases";
    ...
    public static void getUpdateStatusStartupMessage() {
        ...
        final int distance = releasesBehind();
        if (distance > 0) {
            COMPONENT_LOGGER.warn(text("*** You are running an outdated version of Crisp, " + distance + " version" + (distance == 1 ? "" : "s") + " behind ***"));
